...
module.exports = {
  ...
  execute(message) {
    ...
    if (queue.playing) {
      ...
      const pausemebed = new MessageEmbed().setColor("#FD305C")
      .setAuthor(`${message.author.username} paused the music.`, "https://cdn.discordapp.com/attachments/754374425041961000/930191857051381790/ezgif.com-gif-maker_1.gif")
