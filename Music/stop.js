...
async execute(message,args,client) {
  ...
  .setColor("#FD305C")
  .setAuthor(`${message.author.username} stopped the music!`, "https://cdn.discordapp.com/attachments/754374425041961000/930191857051381790/ezgif.com-gif-maker_1.gif"))
  .catch(console.error);
  }
};
