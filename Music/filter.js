...
module.exports = {
  ...
  async execute(message, args, client) {
    ...
    try {
      ...
      message.channel.send(new MessageEmbed()
      .setColor("#FD305C")
      .setAuthor("Applying: " + args[0], "https://cdn.discordapp.com/attachments/754374425041961000/930191857051381790/ezgif.com-gif-maker_1.gif","https://discord.com/api/oauth2/authorize?client_id=930184218766606386&permissions=8&scope=bot")).then(msg =>{
