...
execute(message, args) {
    ...
    queue.textChannel.send(
      new MessageEmbed()
        .setColor("#FD305C")
        .setAuthor(`${message.author.username}#${message.author.discriminator} skipped ${args[0]} songs`, "https://cdn.discordapp.com/attachments/754374425041961000/930191857051381790/ezgif.com-gif-maker_1.gif")
    ).catch(console.error);
  }
};
