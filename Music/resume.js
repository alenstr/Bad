...
execute(message) {
    ...
    if (!queue.playing) {
      ...
      const playembed = new MessageEmbed().setColor("#FD305C")
      .setAuthor(`${message.author.username} resumed the music!`, "https://cdn.discordapp.com/attachments/754374425041961000/930191857051381790/ezgif.com-gif-maker_1.gif")
      //send the approve
